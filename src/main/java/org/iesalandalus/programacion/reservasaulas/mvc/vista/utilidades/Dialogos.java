package org.iesalandalus.programacion.reservasaulas.mvc.vista.utilidades;
...
public class Dialogos {
	...
	public static void mostrarDialogoError(String titulo, String contenido, Stage propietario) {
		...
		/**
		 * Image image = new
		 * Image((LocalizadorRecursos.class.getResourceAsStream("imagenes/logo-ies.png")));
		 * ImageView imageView = new ImageView(image); dialogo.setGraphic(imageView);
		 **/
